...
"""
from Ui_stark import Ui_MainWindow
...
if __name__ == "__main__": #checkea si el script está 5065siendo ejecutado como el prog principal (no importado como un modulo).
